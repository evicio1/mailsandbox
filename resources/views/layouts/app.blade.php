        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
            ...
            >
                ...
                <nav class="flex-1 py-4 space-y-0.5 overflow-y-auto">
                    ...
                    <a href="{{ route('admin.external-mailboxes.index') }}"
                       class="sidebar-link {{ request()->routeIs('admin.external-mailboxes.*') ? 'active' : '' }}">
                        <svg class="sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                        </svg>
                        Ext. Mailboxes
                    ...
                    <a href="{{ route('domains.index') }}"
                       class="sidebar-link {{ request()->routeIs('domains.*') ? 'active' : '' }}">
                        <svg class="sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
